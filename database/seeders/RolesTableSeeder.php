...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $roles = array(
            ...
            [["gerer_entite" => 1,"gerer_documentation" => 1,"gerer_evenement" => 0,"gerer_membre" => 0,"gerer_projet" => 0,"gerer_ticket" => 1,"gerer_post" => 1,"gerer_reseau" => 1,],['niveau_admin' => 16],['conseiller·e',]],
            [["gerer_entite" => 1,"gerer_documentation" => 1,"gerer_evenement" => 0,"gerer_membre" => 0,"gerer_projet" => 0,"gerer_ticket" => 1,"gerer_post" => 1,"gerer_reseau" => 1,],['niveau_admin' => 15],['responsable communication',]],
