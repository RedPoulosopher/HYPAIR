...
class CalendrierController extends Controller
{
    public static function calendrier_asso(){
     ...
     public static function calendrier_general(){
        ...
        Auth::check(); //boolean true si connecte
        Auth::user(); //return utilisateur
        ...
        //TEST
        /*
        $evenements = Evenement::where('confidentialite', '>', 0)
            ->where('confidentialite', '<=', $confidentialite)
            ->where('entite_id', '=', session('entite_id'))
            ->get();
            */
        ...
        //Auth::user()->membres;
        //Entite::whereHas('membres');

        /*function(\Illuminate\Database\Eloquent\Builder $builder) 
        use($confidentialite)
        {
            $builder->where('confidentialite', '>', 0)
            ->where('confidentialite', '<=', $confidentialite)
        }*/
