...
<div id="wrapper">
	<div id="contenu" class="petit">
		<h1>- <span class="icon-security-safe" title="page accessible aux administrateurs">Modifier votre association -</h1>
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="groupe ombre_petite">
				<label class="input_groupe">
					...
					<textarea name="description" class="input" required rows="6">{{old('description_courte') ?? $association->description_courte ?? ''}}</textarea>
				</label>
				...
				<label class="input_groupe">
					...
					<textarea name="description" class="input" required rows="12">{{old('description_md') ?? $association->description_md ?? ''}}</textarea>
				</label>
