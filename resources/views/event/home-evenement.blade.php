...
@section('content')
    ...
    <main id="main-content">
        <section>
            <h1><span class="icon-security-safe" title="page réservée aux administrateurs"></span>Évènements</h1>
            ...
            <div class="section-content">
                ...
                <div class="create-btn-container">
                    <a href="event/create" class="bouton tertiaire ombre_petite administrateur">
                            ...
                            <tbody>
                                @foreach ($evenements as $evenement)
                                    <tr>
                                        ...
                                        <td><?= $evenement['started_at'] ?></td>
                                        <td><?= $evenement['ended_at'] ?></td>
                                        ...
                                        <td>
                                            <a href="event/modifier/<?= $evenement['uid'] ?>" class="bouton_action"
    ...
    <script> 
        ...
        function afficher_informations_supplementaires(index_event, events) {
            ...
            <form method="POST" action="event/suppression/${ events[index_event]['uid']}">
                @csrf
                <button type="submit" name="uid" value=${events[index_event]['uid']} class="bouton ombre_petite administrateur" style="margin:15px;">Valider</button>
            </form>`;
