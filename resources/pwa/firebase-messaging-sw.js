...
self.addEventListener('push', (event) => {
    ...
    return event.waitUntil(handlePushNotification(payload));
})

const handlePushNotification = async (payload) => {
    ...
    //Envoi de la notif de base si ce n'est pas un post
    ...
    // -------------------------- NOTIFICATION TAG -------------------------- //
    // L'ajout du tag permet d'écraser les précédentes notifications ayant le même tag
    // sans renotifier l'utilisateur
    notificationOptions.tag = notifData.tag 
