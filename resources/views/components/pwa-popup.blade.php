<div id="pwa-popup">
    <div id="pwa-popup-content">Pour installer HypAIR, cliquez sur l'icône <img src="{{ Vite::Image('pwa/ios-share-icon.png') }}" alt="Share"> puis <em>"Sur l'écran d'accueil"</em></div>
</div>
