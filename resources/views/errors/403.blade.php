...
@section('content')
    ...
    <p>C'est pas super cool d'essayer d'accèder à des trucs privés, tu sais ? Vois directement avec le bureau de l'entite si tu penses que tu devrais y avoir accès.</p>
