...
return [
    ...
    'response_type' => 'Le type de répose :response_type n\'est pas supporté.',
    'grant_type' => 'Le type d\'attribution g :grant_type n\'est pas supporté.',
    'scope' => 'La permission :scope est invalide.|Les permissions :scope sont invalides.',
    'redirect_uri' => 'L\'URI :uri n\'est pas enregistrée par l\'application.',
    'client_id' => 'Id :client_id n\'est attribué à aucun client.',
    'invalid_client' => 'L\'identifiant secret donné ne correpond pas au client.',
    'invalid_code' => 'Le code d\'autorisation est invalide.',
    'invalid_refresh_token' => 'Le jeton de rafraichissement est invalide.',
