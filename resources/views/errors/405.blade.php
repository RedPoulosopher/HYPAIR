...
@section('content')
    ...
    <p>Si tu veux créer ton club ou ton comité, tu peux le faire en demandant au BDx concerné. S'il s'agit d'une erreur, tu peux <a href="https://air.imt-ne.fr/contact" class="couleur">nous contacter</a>.</p>
